...
def book_flight():
    print(
        "Sure, let's book a flight for you. Can you please tell me your departure and destination cities?:"
    )
    ...
    print(
        "Thank you! Your flight has been booked from {0} to {1} departing on {2} and returning on {3}.".format(
...
def check_flight_availability():
    print(
        "Sure, let me check the availability of flights for you. Can you please tell me your departure and destination cities? :"
    )
    departure = input("Departure city: ")
    destination = input("Destination city: ")
    print("Great! Now, can you tell me your travel dates?")
...
def get_flight_price():
    print(
        "Sure, let me check the price of the flight for you. Can you please tell me your travel dates?"
    )
    departure_date = input("Departure date (YYYY-MM-DD): ")
    return_date = input("Return date (YYYY-MM-DD): ")
...
def cancel_booking():
    print(
        "Sorry to hear that you want to cancel your booking. Please provide me with your booking reference number."
    )
